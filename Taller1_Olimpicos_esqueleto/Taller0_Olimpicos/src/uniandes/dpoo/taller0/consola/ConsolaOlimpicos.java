...
public class ConsolaOlimpicos
{
	...
	public void mostrarMenu()
	{
		...
		System.out.println("13. Consultar el nombre de el país de un atleta");
	...
	private void ejecutarNombreAtletaPais()
	{
		...
		try
		{
			...
			String nombre_atleta = input("Ingrese el nombre del atleta que le interesa");
			String nombre_pais = calculadora.nombreAtletaPais(nombre_atleta);
			
			if (nombre_pais == null)
			{
				System.out.println("No se encontró un país para el atleta llamado " + nombre_atleta);
			}
			else
			{
				System.out.println("El atleta " + nombre_atleta + " es del país " + nombre_pais);
